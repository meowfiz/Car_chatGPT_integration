...
Generated 2026-09-14 13:39. Regenerate with `python notes/gen_openspec_status.py` after updating any change's `tasks.md`. Do not hand-edit this file.

**Overall: 0/25 tasks complete across 1 changes.**

## Summary (most recently updated first)

| Change | Status | Last updated |
|---|---|---|
| [poc-carplay-command](changes/poc-carplay-command/tasks.md) | 0/25 | 2026-09-14 |
